...
class PipelineProgress:
    ...
    def overall_percentage(self) -> float:
        stage_weights = {
            PipelineStage.SCANNING: PipelineConfig.stage_weight_scanning,
            PipelineStage.PARSING: PipelineConfig.stage_weight_parsing,
            PipelineStage.GRAPH_BUILDING: PipelineConfig.stage_weight_building_graph,
            PipelineStage.SUMMARIZING: PipelineConfig.stage_weight_summarizing,
            PipelineStage.METADATA: PipelineConfig.stage_weight_metadata,
            PipelineStage.EMBEDDING: PipelineConfig.stage_weight_embedding,
        }

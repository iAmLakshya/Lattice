...
PYTHON_BUILTINS = frozenset({
    ...
    "reversed", "any", "all", "sum", "min", "max", "abs", "round", "input",
    "super", "classmethod", "staticmethod", "property", "callable", "iter",
    "next", "repr", "hash", "id", "dir", "vars", "globals", "locals",
    "compile", "eval", "exec", "format", "Exception", "ValueError",
    "TypeError", "KeyError", "IndexError", "AttributeError", "RuntimeError",
    "StopIteration", "NotImplementedError", "AssertionError", "ImportError",
    "OSError", "IOError", "FileNotFoundError",
})

JS_BUILTIN_TYPES = frozenset({
    "Array", "Object", "String", "Number", "Date", "RegExp", "Function",
    "Map", "Set", "WeakMap", "WeakSet", "Promise", "Error", "Boolean",
    "Symbol", "BigInt", "ArrayBuffer", "DataView", "Int8Array", "Uint8Array",
    "Float32Array", "Float64Array", "Proxy", "Reflect", "Intl",
})
...
JS_BUILTIN_PATTERNS = frozenset({
    ...
    "Object.getOwnPropertyNames", "Object.getPrototypeOf", "Array.from",
    "Array.isArray", "Array.of", "parseInt", "parseFloat", "isNaN",
    "isFinite", "encodeURI", "decodeURI", "encodeURIComponent",
    "decodeURIComponent", "console.log", "console.error", "console.warn",
    "console.info", "console.debug", "console.trace", "JSON.parse",
    "JSON.stringify", "Math.random", "Math.floor", "Math.ceil", "Math.round",
    "Math.abs", "Math.max", "Math.min", "Math.pow", "Math.sqrt", "Date.now",
    "Date.parse", "Promise.resolve", "Promise.reject", "Promise.all",
    "Promise.race", "Promise.allSettled", "Reflect.get", "Reflect.set",
    "Reflect.has", "Reflect.apply", "setTimeout", "setInterval",

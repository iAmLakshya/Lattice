...
Lattice functionality as tools for Claude Code integration.

Usage:
    # Start the MCP server
    python -m lattice.mcp.server
...
class MCPServer:
    """Model Context Protocol server for Lattice.

    This server implements a subset of the MCP protocol to expose
    Lattice functionality as tools for Claude Code.
